...
<a class="nav-link" href="index_guru.php">Data Guru</a><a class="nav-link" href="index_guru.php">Data Guru</a>
...
<input type="text" class="form-control" name="sekolah_asal" value="<?php echo $sekolah_asal;?>"placeholder="nama sekolah_asal" />
</div>
...
<option <?php if($kabupaten == 'Kabupaten Bandung'){echo "selected";}?> value="Kabupaten Bandung">Kabupaten Bandung</option> <option <?php if($kabupaten == 'Kabupaten Bandung Barat') {echo "selected";}?> value="Kabupaten Bandung Barat">Kabupaten Bandung Barat</option>
<option <?php if($kabupaten == 'Kabupaten Sumedang'){echo "selected";}?> value="Kabupaten Sumedang">Kabupaten Sumedang</option>
<option <?php if($kabupaten == 'Kota Bandung'){echo "selected";}?> value="Kota Bandung">Kota Bandung</option> <option <?php if($kabupaten == 'Kota Cimahi') {echo "selected";}?> value="Kota Cimahi">Kota Cimahi</option>
