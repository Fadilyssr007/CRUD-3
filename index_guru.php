...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
    ...
    <div class="container mt-4">
        <h2>Data Siswa</h2><br>
        <a class="btn btn-primary" href="kelola_guru.php" role="button">Kelola Data guru</a>
        <br><br>
        <table class="table table-striped">
            ...
            <tbody>
                ...
                while($siswa = mysqli_fetch_array($query)) {
                    ...
                    echo "<a href='kelola_guru.php?edit=" . $siswa['id_guru'] . "' class='btn btn-info'>Edit</a>";
                  echo  " <a href='proses_guru.php?hapus=" . $siswa['id_guru'] . "' class='btn btn-primary'>Delete</a>";
                        echo  "</td>";
                    echo "</tr>";
                }
                ?>
